...
[![](https://i.imgur.com/xG74tOh.png)](https://cubos.academy/)

O objetivo deste exercício é replicar o website encontrado no arquivo 'Desafio front academy 1.fig' utilizando apenas HTML e CSS.

# Como executar o projeto

Para a execução do projeto basta apenas você ter baixado localmente todos os arquivos deste diretório e abrir o arquivo `index.html` no seu navegador.

Originalmente foi dito que o projeto não precisaria ser responsivo, então este projeto foi feito para um monitor com proporções 5:4 e resolução de 1280x1024. Mas o projeto fica bem aprazível nas outras resoluções também.
